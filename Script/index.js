...
let randomProduct = [
  {
    image: `https://apollo-singapore.akamaized.net/v1/files/swgb4g5n1eij3-IN/image;s=300x600;q=60`,
  ...
  {
    image: `https://apollo-singapore.akamaized.net/v1/files/0ruqo3z1dhle-IN/image;s=300x600;q=60`,
...
let url = `https://olxapi-58tk.onrender.com/randomData`;
let getData = async () => {
